...
#detailContainer{background: white; z-index: 100; position: absolute; left: 0; top: 0; width: 100%;}
...
.detail_player .swiper-slide img{ width:100%; margin-bottom: 5px; height: 80px;}
