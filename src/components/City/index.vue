...
<style scoped>
#content .cbody{ margin-top: 45px;  display: flex; width:100%; position: relative; top: -30px; bottom: 0px; }
...
.cbody .city_hot h2{ padding-left: 15px; line-height: 30px; font-size: 14px; background:#F0F0F0; font-weight: normal;}
...
.cbody .city_sort h2{ padding-left: 15px; line-height: 30px; font-size: 14px; background:#F0F0F0; font-weight: normal;}
